      ...
      <div className="container">
        ...
        <div className="d-flex">
          <div className="support_item">
            ...
            <h4>Guide Book</h4>
            <a href="https://drive.google.com/file/d/1u3bkSMql1vXmfDZymlONYTFzrW9wZwg6/view" className="software_banner_btn btn_submit f_size_15 f_500">
              Download
            </a>
          </div>
          <div className="support_item">
            ...
            <a href="https://drive.google.com/file/d/1u3bkSMql1vXmfDZymlONYTFzrW9wZwg6/edit?disco=AAAAghNuBRY" className="software_banner_btn btn_submit f_size_15 f_500">
              Download
            </a>
          </div>
        </div>
